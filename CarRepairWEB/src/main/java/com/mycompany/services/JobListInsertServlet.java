...
public class JobListInsertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        JobList modelJob = (JobList)context.getAttribute("JobListModel");
        if(modelJob == null) {
            modelJob = new JobList();
            context.setAttribute("JobListModel", modelJob);
        }       
       ...
       try{
           modelJob.addJob(new Job(name, surname, model, registration, parseDouble(mileage)));
